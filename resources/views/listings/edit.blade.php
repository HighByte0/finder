...
<x-layout>
    <x-card class="p-10 rounded max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/listings/{{$listing->id}} }}" enctype="multipart/form-data" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="mb-6">
                <button class="bg-laravel text-white rounded py-2 px-4 hover:bg-black" style="border-raduis:0 0 50px " type="submit">
                    validate edit job
                </button>
